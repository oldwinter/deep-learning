            ...
            <div className="modal is-active">
                ...
                <div className="modal-card">
                    ...
                    <footer className="modal-card-foot">
                        <button type="submit" className="button is-primary" onClick={this.props.okAction}>Login</button>
            ...
            <nav className="level">
                    ...
                    {this.state.isLogin ? (
                        <div className="level-left">
                            <div className="level-item button is-primary" onClick={this.onLogout}>Logout</div>
                            <div className="level-item ">Current User: {Cookies.get('user')}</div>
                        </div>
                    )
                        :
                        (<div className="level-left">
                            <div className="button is-primary" onClick={this.onLogin}>Login</div>
                        </div>)}
