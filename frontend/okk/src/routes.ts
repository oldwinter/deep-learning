...
const routerConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/dashboard/workplace', component: Workplace },
      ...
      { path: '/form/step', component: FormStep },
      { path: '/form/classified', component: FormClassified },
      { path: '/form/hierarchical', component: FormHierarchical },
      { path: '/form/group', component: FormGroup },
      { path: '/form/flow', component: FlowGroup },
      { path: '/detail/basic', component: BasicDetailPage },
      { path: '/detail/advanced', component: Advanced },
      { path: '/list/basic', component: BasicListPage },
      { path: '/list/card', component: CardListPage },
      { path: '/list/table/filter', component: FusionFilterTable },
      { path: '/list/table/mutilcol', component: FusionMutilcolTable },
      { path: '/list/table/singlecol', component: FusionSinglecolTable },
      { path: '/list/table/expand', component: FusionExpandTable },
      { path: '/list/table/action', component: FusionActionTable },
      { path: '/list/table/mergecell', component: FusionMergecellTable },
      { path: '/list/table/singletree', component: FusionSingletreeTable },
      { path: '/list/table/dialog', component: FusionDialogTable },
      { path: '/list/table', component: TableListPage },
      { path: '/feedback/fail', component: FeedbackFail },
      { path: '/feedback/success', component: FeedbackSuccess },
      { path: '/feedback/403', component: FeedbackForbidden },
      { path: '/feedback/404', component: FeedbackNotFound },
      { path: '/feedback/500', component: FeedbackServerError },
